...
namespace Executes.Models
{
    public class GrenadeThrow
    {
        ...
        public GrenadeThrow(Vector nadePosition, QAngle nadeAngle, Vector nadeVelocity, Vector playerPosition, QAngle playerAngle, string grenadeType, DateTime thrownTime)
        {
        ...
        public void Throw(CCSPlayerController player)
        {
            if (Type == "smoke")
            {
                SmokeProjectile.Create(Position, Angle, Velocity, player);
            }
